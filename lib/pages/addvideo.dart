...
import 'package:tiktok_final/pages/confirmpage.dart';
...
class _AddVideoPageState extends State<AddVideoPage> {
  ...
  Future pickvideo(ImageSource src) async{
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context) => ConfirmPage(File(video.path),video.path,src)));
  }
          ...
          child: Center(
            child: Card(
              ...
              child: Container(
                ...
                child: Center(child: Text('Add Video',style: mystyle(30),)),
              ),
            ),
          ),
        ),
